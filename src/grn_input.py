...
def calculation_setting():
    ...
    grn_log.debug(f'print calculation_setting output: depth_step {depth_step}, calculation_setting {calculation_setting}')
...
def build_grn_input(depth, calculation_settings):
    ...
    grn_log.info(f'building psgrn input file for depth {depth}...')
